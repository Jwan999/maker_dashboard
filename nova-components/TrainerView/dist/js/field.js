...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-trainer-view', __webpack_require__(3));
  Vue.component('detail-trainer-view', __webpack_require__(6));
  Vue.component('form-trainer-view', __webpack_require__(9));
});
  ...
  methods: {
    getTrainers: function getTrainers() {
      ...
      axios.get('/api/trainers').then(function (response) {
        ...
        _this.trainer = _this.trainers.filter(function (trainer) {
          return trainer.id == _this.resource.id.value;
        })[0];
        _this.trainerIndex = _this.trainers.indexOf(_this.trainer);
        _this.lastIndex = _this.trainers.length - 1;
        console.log(_this.trainer);
        console.log(_this.trainer);
      });
    },
  ...
  return _c("field", [
    ...
    _c("div", [
                    ...
                    _c(
                      ...
                      [
                        _c("path", {
                          attrs: {
                            d:
                              "M12.4021583,274.775 C9.393825,274.775 6.38549167,273.666667 4.01049167,271.291667 C-0.581175,266.7 -0.581175,259.1 4.01049167,254.508333 L107.243667,151.275 C114.843667,143.675 114.843667,131.325 107.243667,123.725 L4.01049167,20.4919833 C-0.581175,15.9003167 -0.581175,8.30031667 4.01049167,3.70865 C8.60215833,-0.883016667 16.2021583,-0.883016667 20.793825,3.70865 L124.027,106.941667 C132.102,115.016667 136.693667,125.941667 136.693667,137.5 C136.693667,149.058333 132.260333,159.983333 124.027,168.058333 L20.793825,271.291667 C18.418825,273.508333 15.4104917,274.775 12.4021583,274.775 Z",
                            id: "Path"
                          }
                        })
                      ]
      ...
      _c(
        ...
        {
          staticClass:
            "flex flex-wrap lg:space-x-16 space-x-0 items-center my-10"
        },
        [
          _c("div", { staticClass: "w-full lg:w-auto flex justify-center" }, [
            _c("img", {
              staticClass:
                "rounded-full h-60 w-60 shadow object-cover img-border-color",
              attrs: { src: "/storage/" + _vm.trainer.image, alt: "" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "w-full lg:w-auto" }, [
            _c("h1", { staticClass: "text-gray-700 text-lg mt-2" }, [
              _c("span", { staticClass: "text-gray-500" }, [
                _vm._v("\n          Name:\n        ")
              ]),
              _vm._v(" " + _vm._s(_vm.trainer.name))
            ]),
            _vm._v(" "),
            _c("h1", { staticClass: "text-gray-700 text-lg mt-2" }, [
              _c("span", { staticClass: "text-gray-500" }, [
              ...
              _vm._v(" " + _vm._s(_vm.trainer.phone))
            ]),
            _vm._v(" "),
            _c("h1", { staticClass: "text-gray-700 text-lg mt-2" }, [
              _c("span", { staticClass: "text-gray-500" }, [
              ...
              _vm._v(" " + _vm._s(_vm.trainer.email))
            ]),
            _vm._v(" "),
            _c("h1", { staticClass: "text-gray-700 text-lg mt-2 capitalize" }, [
              _vm._v(_vm._s(_vm.trainer.type) + " Trainer")
            ])
          ])
        ]
      )
